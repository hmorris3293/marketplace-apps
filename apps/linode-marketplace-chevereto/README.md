# Linode chevereto Deployment One-Click APP
...
| chevereto | Latest | Describe what chevereto is |
...
Customers can choose to the deploy the chevereto app through the Linode Marketplace or directly using API. Before using the commands below, you will need to create an [API token](https://www.linode.com/docs/products/tools/linode-api/get-started/#create-an-api-token) or configure [linode-cli](https://www.linode.com/products/cli/) on an environment.
